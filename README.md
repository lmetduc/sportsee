...
### N.B. : :closed_book:
l'API de SportSee ne fournit des données que pour les utilisateurs d'id X et Y.
l'utilisateur 18 a un rendu alternatif du diagramme "Durée moyenne des sessions", plus pertinent que celui de la [maquette Figma](https://www.figma.com/file/BMomGVZqLZb811mDMShpLu/UI-design-Sportify-FR?node-id=0%3A1).
